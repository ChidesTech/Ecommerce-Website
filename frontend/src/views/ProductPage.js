...
const ProductPage =(props)=>{
    ...
    const{ error:errorList, products,pages, page,loading:loadingList} = productList;
    ...
    return(<ProductPageStyles>
      ...
      /> :
       ...
       <li><button id="add-btn" onClick={addToCartHandler} className="btn">Add To Cart<i className="fa fa-cart-plus fa-lg"></i></button></li>
        ...
        <div id="reviews">
            <h3 style={{marginLeft:"1rem",fontSize:"2.5rem", color:"steelblue", textShadow:"1px 1px 1px black"}}>Customer Reviews</h3>
             ...
             <li style={{ marginLeft:"-4rem",}}>
                  {userInfo ?
                   <form action=""   onSubmit={submitHandler} className="form">
                      <div><h3 style={{color:"steelblue", textShadow:"1px 1px 1px black"}}>Submit a review and rating</h3> </div>
                     
                         <div style={{display:"flex", flexDirection:"row", justifyContent:"space-between"}}>
                             <div><label style={{color:'steelblue'}} htmlFor="rating">Rating <i  className="fa fa-star"></i></label></div>
                         <div  style={{fontSize:"1.6rem" ,fontWeight:"bold", color:"steelblue"}} >
...
<div>
    <label style={{color:"steelblue"}} htmlFor="comment">Comment <i className="fa fa-edit"></i></label>
    <textarea style={{border:"2px solid steelblue"}} name="" value={comment} id="" onChange={(e)=>setComment(e.target.value)} cols="30" rows="3"></textarea>
</div>
...
{loadingReviewCreate && <LinearProgress
           ...
           {errorReviewCreate && 
            <Popup variant="danger">{errorReviewCreate}</Popup>
                  ...
                  (<Popup> <a style={{fontWeight:"bolder", color:"steelblue"}} href="/login">Login</a> to submit a review</Popup>)}
              </li>
        ...
        <h2 style={{textAlign:"center",marginTop:"4rem", marginBottom:"-9rem", color:"steelblue", textShadow:"1px 0 0 black"}}>Product Gallery </h2>
