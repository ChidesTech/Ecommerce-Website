...
if(!user){
  ...
  const submitHandler=(event)=>{
    ...
    return ( <div>
            {(passwordsNotMatch && !successUpdate && !loadingUpdate) &&  <><Popup variant="danger">Passwords Don't Match</Popup></>}
    ...
    /> }
            ...
            <div>
              ...
              <div>
                ...
                <input
                style={{border:"none" ,marginLeft:"-1rem", fontWeight:"bolder", color:"steelblue",fontSize:"1.8rem", textShadow:"1px 0 0 black"}}
                  id="name"
                  type="text"
