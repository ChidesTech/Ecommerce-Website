...
const deleteHandler=(userId)=>{
   if(window.confirm("Are you sure you want to delete this user?")){
    ...
    return (<div className="order-tbl">
      <h1 style={{textAlign:"center",color:"steelblue",textShadow:"1px 1px 1px black", fontSize:"2.2rem"}}>Users</h1>
...
<>
<thead>
        <tr style={{background:"white",textShadow:"1px 1px 1px black",color:"steelblue"}}>
            <th>S.N</th>
            <th>Username</th>
             <th>Email</th>
             <th>Admin</th>
        ...
        {users.map((user)=>{
            ...
            <tr key={user._id}>
                ...
                <td><button style={{backgroundColor:"steelblue",marginRight:"1rem",cursor:"pointer", color:"white"}} type="button" className="btn-small"
