...
return(<ProjectSectionStyles>
      <h1 style={{textAlign:"center",color:"steelblue",textShadow:"1px 1px 1px black", fontSize:"2.2rem"}}>Administrator Products</h1>
...
<thead>
    <tr style={{backgroundColor:"white", padding:"1rem 0"}}>
        ...
        style={{backgroundColor:"steelblue",marginRight:".5rem",cursor:"pointer", color:"white" ,padding:"1.2rem 1rem"}}
         className="btn-small">Add Product <i className="fa fa-plus"></i></button></th>
    </tr>
</thead>
<tbody>
