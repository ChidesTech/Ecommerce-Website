...
props.history.push("/product-list");
  ...
  {loading ? (
          ...
          /> 
            ...
            className="form">
               <div style={{marginBottom:"-3rem", textAlign:"center"}} className=""><h2>Edit Product Details</h2></div>
          <div >
...
<option style={{padding:"1rem", fontSize:"1.6rem"}}  value="">--Select Category--</option>
 ...
 {/* <input type="text" id="category" required placeholder="Enter Category" value={category} onChange={(e)=> setCategory(e.target.value)}/> */}
          ...
          <div style={{display:"flex",justifyContent:"space-between" ,flexDirection:"row-reverse", marginTop:"1rem"}} >
              ...
              <button onClick={()=>back(productId)} style={{width:"40%", backgroundColor:"transparent", borderColor:"transparent", color:"steelblue", boxShadow:"1px 1px 1px 1px steelblue"}} type="button" className="btn">Cancel</button>
