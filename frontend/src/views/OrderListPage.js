...
const deleteHandler=(orderId)=>{
   if(window.confirm("Are you sure you want to delete this order?")){
    ...
    return (<div className="order-tbl">
      <h1 style={{textAlign:"center",color:"steelblue",textShadow:"1px 1px 1px black", fontSize:"2.2rem"}}>Orders</h1>
...
<thead>
    ...
    <td>{order.user !== null ? order.user.name : "User" }</td> 
                ...
                <td>   <button style={{backgroundColor:"steelblue",padding:".75rem 1.5rem",marginRight:"1rem",cursor:"pointer", color:"white"}} type="button" className="btn-small"
