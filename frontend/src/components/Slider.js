...
const Slider = (props) => {
  ...
  const contents = [
    {id:"a",image:"/images/rotating-banners.jpg", text: "Heavy Discount", text2:"At ChideStore, We Offer Heavy Discounts."},
    {id:"b",image:"/images/leopard.jpg", text: "Trendy Wears", text2:"Fashion wears always in vogue."},
    ...
    {id:"e",image:"/images/shoe.jpg", text: "Become A Seller", text2:"Partner With Us And Attain Financial Growth."},
